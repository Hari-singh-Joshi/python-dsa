...
SECRET_KEY = 'django-insecure-yy%zd9o+hw+w%ncrmf1o4&qkj)vo%@o_hvjjl38b_kcdj%fz(5'
...
# In the _close method of djongo/base.py
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'static'),  # Corrected to be a string
]
